...
export const PRESETS = [
  ...
  { name: "ChatGPT Plus", category: "AI 工具", color: "#10a37f", defaultFee: 20, defaultCurrency: "USD" },
  { name: "Claude Pro", category: "AI 工具", color: "#d97757", defaultFee: 20, defaultCurrency: "USD" },
  { name: "GitHub Copilot", category: "生產力工具", color: "#24292f", defaultFee: 10, defaultCurrency: "USD" },
  { name: "Adobe Creative Cloud", category: "生產力工具", color: "#ff0000", defaultFee: 1888, defaultCurrency: "TWD" },
  { name: "Microsoft 365", category: "生產力工具", color: "#0078d4", defaultFee: 219, defaultCurrency: "TWD" },
  ...
  { name: "Notion", category: "生產力工具", color: "#0f0e1a", defaultFee: 10, defaultCurrency: "USD" },
  { name: "Figma", category: "生產力工具", color: "#a259ff", defaultFee: 15, defaultCurrency: "USD" },
  { name: "Canva Pro", category: "生產力工具", color: "#00c4cc", defaultFee: 120, defaultCurrency: "USD" }
];
